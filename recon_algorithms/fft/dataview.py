...
#    dataview.py
#
#   A program for displaying and comparing rectangular arrays as colormaps.
#   The arrays are read either from  numpy .npy files representing rectangular arrays
#   or from .d files (proprietary format of L. Kunyansky)
#
#   In order to run from command line:
#        dataview filename
#   or
#        dataview filename1 filename2
#
#   The latter assumes that the two files represent rectangular arrays of the same
#   dimensions. The difference between the two is displayed.
#
#   When the image is displayed, press "h" for help on the possible shortcut commands.
#
#---------------------------------------------------------------------------------------
